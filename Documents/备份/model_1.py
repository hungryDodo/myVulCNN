...
from calculateScore import read_scores_to_dict
import logging
import json
...
class CNN_Classifier():
    def __init__(self, max_len=250, n_classes=2, epochs=100, batch_size=128, learning_rate=0.0001, \
                 result_save_path="/root/data/qm_data/vulcnn/data/result2s", item_num=0, hidden_size=100):
